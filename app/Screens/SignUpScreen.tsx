...
export default function SignUpScreen() {
	...
	const asyncSignUpWarning = async () => {
		return new Promise<boolean>((response) => {
			Alert.alert(
				"Keep Data?",
				"Would you like to keep the data thats currently on the device or erase it and start fresh?",
				[
					{
						text: "Start Fresh",
						style: "destructive",
	...
	const validateInput = (): boolean => {
		...
		if (
			username === "" ||
			username.indexOf("@") < 2 ||
			username.indexOf("@") > username.length - 5
		) {
			...
			>
				...
				>
					<ScrollView style={registrationStyles.containerScrollView}>
						...
						<Text style={registrationStyles.subHeading}>
							Personal Details:
						</Text>
						<TextInput
							style={[
								...
								{
									backgroundColor: firstNameErrorMessage
										? "tomato"
										: "white",
								},
							]}
						...
						<TextInput
							...
							style={[
								globalStyles.credentialInput,
								{
									backgroundColor: lastNameErrorMessage
										? "tomato"
										: "white",
								},
							]}
						...
						<TextInput
							...
							style={[
								globalStyles.credentialInput,
								{
									backgroundColor: usernameErrorMessage
										? "tomato"
										: "white",
								},
							]}
						...
						<TextInput
							...
							style={[
								globalStyles.credentialInput,
								{
									backgroundColor: passwordErrorMessage
										? "tomato"
										: "white",
								},
							]}
						...
						<TextInput
							...
							style={[
								globalStyles.credentialInput,
								{
									backgroundColor: confirmPasswordErrorMessage
										? "tomato"
										: "white",
								},
							]}
